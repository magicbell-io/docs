...
1. Sign up for [SendGrid](https://signup.sendgrid.com/) and [obtain an API key](https://docs.sendgrid.com/ui/account-and-settings/api-keys). It must have full access to the [`Mail Send` endpoint](https://docs.sendgrid.com/api-reference/mail-send/mail-send).
...
<img
  ...
  src="/docs/uploads/email_sendgrid.gif"
...
In addition to our own [email templates](/docs/templates.mdx), MagicBell can deliver email notifications using SendGrid's.
