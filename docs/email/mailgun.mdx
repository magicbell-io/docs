...
1. Sign up for [Mailgun](https://signup.mailgun.com/new/signup) and [obtain an API key](https://help.mailgun.com/hc/en-us/articles/203380100-Where-can-I-find-my-API-key-and-SMTP-credentials-).
1. From the **Channels** page in your Dashboard, click the ⚙ icon next to **Email** to access Email Channel Settings.
1. Under **Mailgun**, enable the provider and enter the API key from step 1 as well as your sender domain, then click **Save**.

<img
  className="full-mobile"
  src="/docs/uploads/email_mailgun.gif"
...
In addition to our own [email templates](/docs/templates.mdx), MagicBell can deliver email notifications using Mailgun's.
