...
**Note:** The Batch Notifications feature is currently only available for email with support for other channels coming soon! If you'd like to find out more or would like to have early access, let us know in the [slack community](http://magicbell.community).
