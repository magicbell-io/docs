...
a a cursor based pagination model based on the connection pattern.
...
The GraphQL API imposes a limit of 200 requests per second by project. If the limit is exceeded, you will get an HTTP 429 Too Many Requests response.
