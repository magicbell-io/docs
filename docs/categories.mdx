...
<img className="full-mobile" src="/docs/uploads/Preferences.png" />

If you build a custom UI or integrate these preferences into your existing
settings screen, you can use the [notification preferences API endpoint](https://magicbell.com/docs/rest-api/reference#put-preferences).
