---
title: Segments (API)
subtitle: Learn how to send a notification to a segment of users using the API
---
...
attributes on your MagicBell users. You can do it using our [users API endpoints](https://www.magicbell.com/docs/rest-api/reference#create-user).
