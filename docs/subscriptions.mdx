...
1. Jane goes into your app and subscribes to the category `support-ticket`.
...
1. Our backend creates the subscription via the [API](/docs/graphql-api/reference#create-subscription).
