...
1. Jane unsubscribes from `pull-request-1234` and stops receiving notifications for that pull request, but will continue to be notified of others in that category.
